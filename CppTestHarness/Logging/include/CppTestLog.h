...
namespace CppTestHarness {
	...
	protected:
		CppSharedPtr<ILogOutput> m_output;	///< logOutput pointer.
		CppSharedPtr<ILog> m_summaryLog;	///< summary logger pointer.
		...
		///
		/// @return	true if successful, otherwise false.
		virtual bool WriteEntry(ICase& testCase) = 0;
