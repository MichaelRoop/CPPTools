#if !defined(CPP_TEST_COMMAND_LINE_READER_H)
#define CPP_TEST_COMMAND_LINE_READER_H
...
namespace CppTestHarness {
	...
	///
	///--------------------------------------------------------------------------------------
	class TSTHARNESS_API CommandLineReader : public ScriptReaderBase {
	public:
		...
		TestInfoObject GetNextTest(Cpp_string& fixtureName);

	private:
		const Cpp_string	m_line;
		bool m_used;
...
TSTHARNESS_EXPORT template class TSTHARNESS_API std::allocator<CppTestHarness::CommandLineReader*>;
TSTHARNESS_EXPORT template class TSTHARNESS_API std::vector<CppTestHarness::CommandLineReader*>;
