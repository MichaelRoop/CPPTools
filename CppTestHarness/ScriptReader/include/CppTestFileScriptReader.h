...
namespace CppTestHarness {
	...
	///
	///--------------------------------------------------------------------------------------
	class TSTHARNESS_API FileScriptReader : public ScriptReaderBase {
	public:
	...
	private:
		const Cpp_string m_filename; ///< The file name of the script.
		Cpp_ifstream m_scriptStream; ///< The file object.

	};

}

TSTHARNESS_EXPORT template class TSTHARNESS_API std::allocator<CppTestHarness::FileScriptReader*>;
TSTHARNESS_EXPORT template class TSTHARNESS_API std::vector<CppTestHarness::FileScriptReader*>;
