#if !defined(CPP_TEST_VECTOR_LINE_READER_H)
#define CPP_TEST_VECTOR_LINE_READER_H
...
namespace CppTestHarness {
	...
	///
	///--------------------------------------------------------------------------------------
	class TSTHARNESS_API VectorLineReader : public ScriptReaderBase {
	public:
...
TSTHARNESS_EXPORT template class TSTHARNESS_API std::allocator<CppTestHarness::VectorLineReader*>;
TSTHARNESS_EXPORT template class TSTHARNESS_API std::vector<CppTestHarness::VectorLineReader*>;
