...
public:
	...
	virtual void RunTest(const CppUtils::Cpp_string& name, const TestCaseArguments& args) = 0;
	...
	virtual bool HasTest(const CppUtils::Cpp_string& name) const = 0;


	/// @brief	Retrieve the Fixture and test case names
	virtual CppUtils::CppSharedPtr<IFixutureTestCaseNames> GetTestNames() const = 0;
	...
	virtual const CppUtils::Cpp_string& Name() const = 0;
...
protected: // the register test methods could be public
	...
	virtual void RegisterTest(
		...
		const CppUtils::Cpp_string& description) = 0;
	...
	virtual const TestCaseArguments& CurrentArgs() const = 0;
...
TSTHARNESS_EXPORT template class TSTHARNESS_API std::allocator<CppTestHarness::IFixture*>;
TSTHARNESS_EXPORT template class TSTHARNESS_API std::vector<CppTestHarness::IFixture*>;
