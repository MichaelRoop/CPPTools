...
namespace CppTestHarness {
	...
	///
	///--------------------------------------------------------------------------------------
	class TSTHARNESS_API Fixture : public IFixture {

	public:

		/// @brief	Constructor
		///	@param	name	Name of the test case fixture.
		Fixture(const CppUtils::Cpp_string& name);
		...
		virtual bool HasTest(const CppUtils::Cpp_string& name) const;


		/// @brief	Retrieve the Fixture and test case names
		virtual CppUtils::CppSharedPtr<IFixutureTestCaseNames> GetTestNames() const;
		...
		virtual const CppUtils::Cpp_string& Name() const;
	...
	protected:
		...
		virtual const TestCaseArguments& CurrentArgs() const;

	private:

		CppUtils::Cpp_string			m_name;
		TestCaseArguments				m_args;
		...
		CppUtils::CppSharedPtr<IFixutureTestCaseNames> m_testCaseNames; ///< Object that holds test case name information
	...
	private:
		...
		void SetCurrentTest(const CppUtils::Cpp_string& name);
...
TSTHARNESS_EXPORT template class TSTHARNESS_API std::allocator<CppTestHarness::Fixture*>;
TSTHARNESS_EXPORT template class TSTHARNESS_API std::vector<CppTestHarness::Fixture*>;
