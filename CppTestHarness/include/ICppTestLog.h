...
#include "include/ICppTestLogOutput.h"
...
namespace CppTestHarness {
	...
	public:
		...
		/// @return	true if successful, otherwise false.
		virtual bool LogTest(ICase& testCase) = 0;
...
TSTHARNESS_EXPORT template class TSTHARNESS_API std::allocator<CppUtils::CppSharedPtr<CppTestHarness::ILog> >;
TSTHARNESS_EXPORT template class TSTHARNESS_API std::vector<CppUtils::CppSharedPtr<CppTestHarness::ILog> >;
