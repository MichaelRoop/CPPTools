...
///--------------------------------------------------------------------------------------
/// @file	Cpp_functors.h
/// @brief	Functors that are generic enough to be used widely.
///
/// @author		Michael Roop
/// @date		2021
/// @version	1.0
...
namespace CppUtils {
	...
	///
	///--------------------------------------------------------------------------------------
	struct CPPUTILS_API AnsiiWideCharToNarrow {
		...
		///
		/// @exception	Cpp_exception if the chars to convert exceeds the size of the receptor 
		///				vector.
		///
		/// @param	c	The character to be converted to narrow.
		void operator () (const wchar_t& c) {
			Cpp_exception::assertCondition(m_pos < m_output.size(), FL, L("Exceeded receptor limits"));
	...
	///
	///--------------------------------------------------------------------------------------
	struct CPPUTILS_API NarrowCharToWide {
